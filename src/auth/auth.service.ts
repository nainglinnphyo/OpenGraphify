            ...
            return this.prismaService.user
                ...
                .then((createUser) => {
                    ...
                    this.emailService.sendMail(
                        createUser.email,
                        'Account Confirmation Required - Please Verify Your Email',
                        `${join(
                            __dirname
                        )}/../../templates/confirm-template.hbs`,
                    ...
                    return {
                        ...
                        message:
                            'User registered successfully. A confirmation email will be sent shortly.',
                    }
                })
                .catch((e) => {
                    throw e
